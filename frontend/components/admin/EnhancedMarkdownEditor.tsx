...
export default function EnhancedMarkdownEditor({ content, onChange }: EnhancedMarkdownEditorProps) {
        ...
        {viewMode !== 'preview' && (
          <div className="relative">
            <textarea
              ...
              placeholder="Start writing your note... Use the toolbar above or keyboard shortcuts. For math: $inline$ or $$block$$"
            />
            {viewMode === 'split' && (
      ...
      <div className="flex flex-col gap-2 text-xs text-gray-500">
        <div className="flex items-center justify-between">
          <div className="flex gap-4">
            <span>💡 <strong>Tip:</strong> Use $inline$ for inline math and $$block$$ for block math. Ctrl+M for inline math.</span>
          </div>
          <div className="flex gap-2">
            <kbd className="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs">Ctrl+B</kbd>
            <span>Bold</span>
            <kbd className="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs">Ctrl+M</kbd>
            <span>Math</span>
          </div>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-md px-3 py-2 text-blue-800">
          <strong>📐 LaTeX Math:</strong> Inline math: <code className="bg-blue-100 px-1 rounded">$E = mc^2$</code>. 
          Block math: <code className="bg-blue-100 px-1 rounded">$$\int_{-\infty}^{\infty} e^{-x^2} dx = \sqrt{\pi}$$</code>
        </div>
      </div>
    </div>
  )
